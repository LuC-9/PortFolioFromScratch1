...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex flex-col md:flex-row items-center justify-between relative bg-black/60 text-white px-6 py-12 pt-40 md:pt-12">
      {/* Left Section */}
      ...
      <div className="flex flex-col md:flex-row gap-4 ml-auto mt-6 md:mt-0 md:gap-6">
        {/* Mobile: Horizontal social links without text */}
        ...
        {/* Desktop: Vertical social links with usernames */}
